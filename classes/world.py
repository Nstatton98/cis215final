...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        if r < 0.20:
            ...
            self.alive_text = "A parasitic lifeform rushes toward you!"
            self.dead_text = "The corpse of a Parasite lies motionless on the ground." \
            ...
            self.alive_text = "A Parasite... no, a Parasite Zombie emerges from the darkness!"
            ...
            self.alive_text = "An unerving feeling shivers down your spine."\
            ...
            self.alive_text = "A Slimy Blob attaches itself to chunks of abandoned machinery and spacecraft!" \
                              "A Space Junk Golem forms!"
            self.dead_text = "The unknown slimy substance has dissapated," \
